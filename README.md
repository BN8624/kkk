...
| 🟣 자원 후국 | 사격과 경제 | **장궁** — 궁병의 사거리 +1 | **쇠뇌대** — 기본 방어 최대 2 관통 | 궁병 2기, 금 60 |
...
- **전략 전쟁 (실험, Strategic Layer V0)** — 타이틀에서 진입. SVG 섬 영토 12지역·10턴 캠페인. 군단 토큰 이동·대기·보충, AI 세력 행동, AI 대 AI 자동 해결, 인간 참여 시 기존 육각 전술 전투와 결과 지속. Phase 8-2에서 카드 그리드를 실제 영토 지도로 교체. Phase 9 시각·사운드 마감 전 실험 모드
...
- **Strategic Layer V0** 개발을 시작했다. 순수 상태·명령·전술 전투 브리지 계약은 [`docs/STRATEGIC_LAYER_V0.md`](docs/STRATEGIC_LAYER_V0.md)를 참고한다.
- 전술 밸런스는 안정 동결이며, 이번 단계에서 공개 플레이 화면은 바뀌지 않는다.
- 라운드·물류·병종 식별 마무리는 **Phase 9**로 미룬다.
