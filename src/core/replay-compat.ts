 ...
 * 2.1.x 공용 exact.
 * 2.2.0–2.2.2: 2.2.3 밸런스 재조정(왕관 방어·기병 비용·정복 AI·조기 종료 유예 등)으로 결과가 달라져 playable-unverified.
 * 2.2.3+(2.2.x): 현행 exact. 레지스트리는 순차 매칭이므로 구체 패치를 2.2.x 앞에 둔다.
 */
export const REPLAY_RULE_VERSIONS: ReplayRuleVersion[] = [
  ...
  // 2.2.0–2.2.2: 2.2.3 밸런스·규칙 재조정 — 전투·종료 분기, 정본 검증 불가
