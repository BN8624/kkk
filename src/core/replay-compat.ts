 ...
 * 2.1.x 공용 exact.
 * 2.2.0–2.2.2: 수호 태세 방어 +2→+1(2.2.3)로 전투 결과가 달라져 playable-unverified.
 * 2.2.3+(2.2.x): 현행 brace exact. 레지스트리는 순차 매칭이므로 구체 패치를 2.2.x 앞에 둔다.
 */
export const REPLAY_RULE_VERSIONS: ReplayRuleVersion[] = [
  ...
  // 2.2.0–2.2.2: brace defenseBonus 2→1 — 전투 분기, 정본 검증 불가
  { versionRange: '2.2.0', compatibility: 'playable-unverified' },
  { versionRange: '2.2.1', compatibility: 'playable-unverified' },
  { versionRange: '2.2.2', compatibility: 'playable-unverified' },
  // 2.2.3+: 현행 수호 태세(+1) exact
